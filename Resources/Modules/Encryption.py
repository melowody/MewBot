import discord, asyncio, aiohttp, base64, Resources.Lib.GDLib as GDLib, Resources.Lib.ImgLib as ImgLib, itertools, math, hashlib, binascii
...
class Encryption:
    ...
    async def sha512e(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="SHA512 Hash", value=hashlib.sha512(args.encode('utf-8')).hexdigest())
        await ctx.send(embed=emb)
    ...
    async def sha256e(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="SHA256 Hash", value=hashlib.sha256(args.encode('utf-8')).hexdigest())
        await ctx.send(embed=emb)
    ...
    async def md5e(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="MD5 Hash", value=hashlib.md5(args.encode('utf-8')).hexdigest())
        await ctx.send(embed=emb)
    ...
    async def hexd(self, ctx, *, args):
        try:
            ...
            await cx.send("That is not a valid Hex encoded string!")
    ...
    async def hexe(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Hex Encoded String", value=base64.b16encode(args.encode('utf-8')).decode())
        await ctx.send(embed=emb)
    ...
    async def uppercase(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Uppercase String", value=args.upper())
        await ctx.send(embed=emb)
    ...
    async def lowercase(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Lowercase String", value=args.lower())
        await ctx.send(embed=emb)
    ...
    async def length(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Length of String", value=str(len(list(args))))
        await ctx.send(embed=emb)
    ...
    async def gjpd(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="GJP Decoded Message", value=GDLib.gjpd(args))
        await ctx.send(embed=emb)
    ...
    async def a85d(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Ascii85 Decoded Message", value=base64.a85decode(args.encode(), adobe=True).decode() if args.endswith('~>') else base64.a85decode(args.encode()).decode())
        await ctx.send(embed=emb)
    ...
    async def a85e(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Ascii85 Encoded Message", value=base64.a85encode(args.encode(), adobe=True).decode())
        await ctx.send(embed=emb)
    ...
    async def binary(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Text to Binary", value=''.join([bin(ord(ch))[2:].zfill(8) for ch in args]))
        await ctx.send(embed=emb)
    ...
    async def b64d(self, ctx, *, args):
        try:
            emb = (discord.Embed(color=0xf7b8cf))
            emb.add_field(name="Decoded Base64 String", value=base64.b64decode(args).decode())
            await ctx.send(embed = emb)
        except binascii.Error:
    ...
    async def b64e(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Encoded Base64 String", value=base64.b64encode(args.encode()).decode())
        await ctx.send(embed = emb)
    ...
    async def flip(self, ctx, *, args):
        emb = (discord.Embed(color=0xf7b8cf))
        emb.add_field(name="Flipped Text", value=args[::-1])
        await ctx.send(embed = emb)
